...
describe 'tasks' do
  it 'when agent is disabled and action is enable' do
    ...
    result = run_bolt_task('support_tasks::st0286_change_puppet_daemon_runmode', 'puppet_mode' => 'enable')
  ...
  it 'when agent is enabled and action is disable ' do
    ...
    result = run_bolt_task('support_tasks::st0286_change_puppet_daemon_runmode', 'puppet_mode' => 'disable', 'reason' => 'taskdisabled')
