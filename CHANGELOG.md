...
- \(maint\) Update Puppet VS Code Extension ID [\#85](https://github.com/puppetlabs/support-tasks/pull/85) ([jpogran](https://github.com/jpogran))
...
- 1.1.2 update [\#82](https://github.com/puppetlabs/support-tasks/pull/82) ([MartyEwings](https://github.com/MartyEwings))
- st1105 addition [\#80](https://github.com/puppetlabs/support-tasks/pull/80) ([pgrant87](https://github.com/pgrant87))
- \(SUP-1643\) [\#76](https://github.com/puppetlabs/support-tasks/pull/76) ([pgrant87](https://github.com/pgrant87))
- Minor update for osp [\#75](https://github.com/puppetlabs/support-tasks/pull/75) ([pgrant87](https://github.com/pgrant87))
...
- 1.1.1 release prep [\#73](https://github.com/puppetlabs/support-tasks/pull/73) ([MartyEwings](https://github.com/MartyEwings))
- \(MAINT\) Update project page to point to github [\#70](https://github.com/puppetlabs/support-tasks/pull/70) ([npwalker](https://github.com/npwalker))
...
- fix new interactivity requirement for bundler install [\#68](https://github.com/puppetlabs/support-tasks/pull/68) ([MartyEwings](https://github.com/MartyEwings))
